    ...
    operations = [
        migrations.SeparateDatabaseAndState(
            ...
            database_operations=[
                ...
                # Django creates a check constraint for Positive*IntegerField that is not
                # applicable to CharField. Also, some database backends do not support
                # altering columns with (check) constraints on them.
                migrations.RunPython(remove_task_check_constraints, add_task_check_constraints),
